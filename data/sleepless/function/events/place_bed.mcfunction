...
execute unless entity @e[tag=sleepless.slept,distance=..4] unless entity @e[tag=sleepless.newBed,distance=..4] run summon marker ~ ~ ~ {Tags:["sleepless.newBed","smithed.strict"]}
