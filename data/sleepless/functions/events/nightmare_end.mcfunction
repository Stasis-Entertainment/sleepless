...
execute at @s if score showDeathMessages sleepless.value matches 1.. run tellraw @a[distance=4..] [{"selector": "@s","color": "#660000", "italic": true,"bold": true},{"text": " ", "color": "#660000", "bold": true, "italic": true},{"translate": "sleepless.death.nightmare", "color": "#660000", "bold": true, "italic": true}]
